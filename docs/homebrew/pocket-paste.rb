# Cask skeleton for qianiaoo/homebrew-tap (Casks/pocket-paste.rb).
...
cask "pocket-paste" do
  ...
  url "https://github.com/qianiaoo/pocket-paste/releases/download/v#{version}/Pocket.Paste_#{version}_aarch64.dmg"
  name "Pocket Paste"
  desc "Smart clipboard for the menu bar: paste as a card, a GIF, a translation or a summary"
  homepage "https://github.com/qianiaoo/pocket-paste"
