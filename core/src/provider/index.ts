 ...
 *
 *   decider/    typed questions → answers (Jev): jev-cloudflare, jev-api, jev-endpoint, rules, none
 *   generator/  prompt → text (an LLM): openai-compatible (also OpenRouter, Vercel), anthropic, hosted, none
...
export { createDecider, createProvider, deciderFromEnv, DEV_PROXY_URL, JEV_KEY_ENV, PROVIDER_KINDS, providerFromEnv, type ProviderConfig } from "./decider/index.ts";
export { isJevService, JEV_SERVICE_KINDS, JEV_SERVICES, jevApiDecider, type JevService } from "./decider/jev-api.ts";
...
export { createGenerator, DEFAULT_OLLAMA_URL, GATEWAY_BASE_URLS, GENERATOR_KINDS, generatorFromEnv, type GeneratorConfig } from "./generator/index.ts";
