...
export type Request =
  ...
  | { id: number; cmd: "precompose"; text: string; frames?: { image?: string; gif?: string; video?: string }; templatePreferences?: Readonly<Record<string, string>>; disabledTemplates?: readonly string[]; templateFont?: string }
