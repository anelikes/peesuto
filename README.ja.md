...
| **L** | 文字PV：どんなテキストも、文や句の切れ目で場面に分けた動く文字に（MP4。ffmpeg がなければ GIF） |
...
<p align="center">
  <img src="docs/images/templates.png" width="100%" alt="39 のカードスタイル：テキスト、ドキュメント、引用、コード、数字、リスト、会話、表、比較、図、情報カード、リリースノート、ターミナルセッション、差分、エラー、スケジュール、指標、文字PV、QR コード。">
</p>
