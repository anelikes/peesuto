...
- **プレーンテキストからカードに。** 13 のテンプレートと 27 のスタイル。言葉、名前、数字、順番はすべて元のテキストのまま。書き換えも付け足しもしません。
...
<p align="center">
  <img src="docs/images/templates.png" width="100%" alt="27 のカードスタイル：テキスト、ドキュメント、引用、コード、数字、リスト、会話、表、比較、図、情報カード、リリースノート、QR コード。">
</p>
