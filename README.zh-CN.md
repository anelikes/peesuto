...
- **纯文本变卡片。** 19 种模板，39 种样式。字词、人名、数字和顺序都来自原文，不改写，不编造。
...
<p align="center">
  <img src="docs/images/templates.png" width="100%" alt="全部 39 种卡片样式：文本、文档、引用、代码、数字、列表、对话、表格、对比、流程图、信息卡、更新日志、终端会话、代码差异、报错、日程、多项指标、文字 PV 和二维码。">
</p>
